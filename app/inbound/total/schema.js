...
module.exports = Joi.object({
  ...
  agreementNumber: Joi.number().integer().required().messages({
    ...
    'number.integer': `agreementNumber must be an integer`,
  ...
  claimReference: Joi.number().integer().required().messages({
    ...
    'number.integer': `claimReference must be an integer`,
  ...
  totalAdditionalPayments: Joi.number().precision(number15).required().messages({
    ...
    'number.precision': `totalAdditionalPayments should not have more than ${number15} digits after the decimal point`,
  ...
  totalActionPayments: Joi.number().precision(number15).required().messages({
    ...
    'number.precision': `totalActionPayments should not have more than ${number15} digits after the decimal point`,
  ...
  totalPayments: Joi.number().precision(number15).required().messages({
    ...
    'number.precision': `totalPayments should not have more than ${number15} digits after the decimal point`,
  ...
  actions: Joi.array().items(Joi.object({
    ...
    overDeclarationPenalty: Joi.number().precision(number15).required().messages({
      ...
      'number.precision': `overDeclarationPenalty should not have more than ${number15} digits after the decimal point`,
