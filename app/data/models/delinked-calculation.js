const delinkedCalculationDB = (sequelize, DataTypes) => {
  ...
  const delinkedCalculation = sequelize.define('delinkedCalculation', {
    ...
    paymentBand1: { type: DataTypes.STRING, allowNull: false, "Example Output: 30000 Source: DWH | SitiAgri Used on Statement? Yes, Progressive reduction calculation table. Used to show how progressive reductions are calculated." },
    paymentBand2: { type: DataTypes.STRING, allowNull: false, "Example Output: 50000 Source: DWH | SitiAgri Used on Statement? Yes, Progressive reduction calculation table. Used to show how progressive reductions are calculated." },
    paymentBand3: { type: DataTypes.STRING, allowNull: false, "Example Output: 150000 Source: DWH | SitiAgri Used on Statement? Yes, Progressive reduction calculation table. Used to show how progressive reductions are calculated." },
    paymentBand4: { type: DataTypes.STRING, allowNull: false, "Example Output: 9999.99 Source: DWH | SitiAgri Used on Statement? Yes, Progressive reduction calculation table. Used to show how progressive reductions are calculated." },
    ...
    datePublished: { type: DataTypes.DATE, allowNull: true, "Example Output: 2025-05-12 15:08:08.776 Source: DWH | SitiAgri Used on Statement? No, used in logic to determine if a statement has been generated" },
    updated: { type: DataTypes.DATE, allowNull: true, "Example Output: 2025-05-12 15:08:08.776 Source: DWH | SitiAgri Used on Statement? No, used in logic to show when data changes have been made" }
  },
  {
